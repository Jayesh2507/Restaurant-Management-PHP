...
<div class="section white-text" style="background: #B35458; background: white; color:black !important">
  ...
  <?php
	...
	<div class="section right" style="padding: 15px 25px; background: white; color:black !important">
